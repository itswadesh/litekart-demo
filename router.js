...
const ApplyForVendor = () =>
  import('~/pages/apply-for-vendor').then(m => m.default || m)
...
const OrderSuccess = () =>
  import('~/pages/order-success').then(m => m.default || m)
const Cart = () => import('~/pages/cart').then(m => m.default || m)
const Checkout = () =>
  import('~/pages/checkout/index').then(m => m.default || m)
const Payments = () =>
  import('~/pages/checkout/payments').then(m => m.default || m)
const CAddress = () =>
  import('~/pages/checkout/address').then(m => m.default || m)
...
const PaymentMobile = () =>
  import('~/pages/checkout/payment-mobile').then(m => m.default || m)
...
const ForgotPassword = () =>
  import('~/pages/account/forgot-password').then(m => m.default || m)
const ResetPassword = () =>
  import('~/pages/account/reset-password/_token').then(m => m.default || m)
const VerifyToken = () =>
  import('~/pages/account/verify/_token').then(m => m.default || m)
const MyOrders = () =>
  import('~/pages/my/orders/index').then(m => m.default || m)
const MyOrderDetails = () =>
  import('~/pages/my/orders/_id').then(m => m.default || m)
...
const ChangePassword = () =>
  import('~/pages/my/change-password').then(m => m.default || m)
const Pages = () => import('~/pages/page/slug').then(m => m.default || m)
const DynamicPages = () =>
  import('~/pages/page/dynamic').then(m => m.default || m)
