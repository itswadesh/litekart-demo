...
<template>
  <div>
    <div class="mx-2 mb-16 lg:mx-48">
      ...
      <div class="py-6 mx-5">
        ...
        <p class="flex justify-center mb-4 text-xl text-center ">
          ...
          Javascript e-commerce Solution. It offers an fullstack eCommerce
          website to Enterprise businesses to strengthen their footprints in the
          eCommerce space.
        </p>
    ...
    <div class="flex flex-wrap justify-between bg-gray-100 lg:py-12 lg:px-64">
      <div
        class="flex flex-col flex-1 m-6 text-center bg-white rounded-lg shadow"
      >
        <img src="img/mission.png" alt=" " class="" />
        <p class="p-4">
      ...
      <div
        class="flex flex-col flex-1 m-6 text-center bg-white rounded shadow "
      >
        <img src="img/vison.png" alt="" class="" />
        <p class="p-4">
      ...
      <div
        class="flex flex-col flex-1 m-6 text-center bg-white rounded shadow "
      >
        <img src="img/values.png" alt="" class="" />
        <p class="p-4">
