      ...
      <div class="xs:w-full lg:w-2/4 p-2">
        <div class="w-full flex flex-wrap">
          <p class="w-9/12 left-0 text-left text-xs text-gray-500">
            ...
            <i class="fa fa-angle-right" aria-hidden="true"></i> FitBit Smart Band
          </p>
        ...
        <div>
          <div class="w-full flex flex-wrap mt-3 border p-5">
            ...
            <div class="text-sm w-3/5 flex flex-wrap">
              <div class="w-2/5">
                <span class="text-black text-4xl text-center">4.1</span>
                <i class="fa fa-star" aria-hidden="true"></i>
                <br />
                <span class="text-gray-500 text-xs p-1">214 Ratings & 22 Reviews</span>
              </div>
              <div class="w-3/5">
