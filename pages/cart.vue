      ...
      <div class="xs:w-full lg:w-2/4 mt-10 px-2">
        <div class="w-full flex flex-wrap hr-line justify-between pb-2">
          ...
          <div class="text-gray-600 right-0 rounded relative">
            ...
            />
            <button
              class="absolute right-0 text-sm mt-2 text-gray-500 pr-2 focus:outline-none hover:text-gray-600"
            >
          ...
          <div class="lg:w-4/5 right-0 xs:9/12">
            <div class="pl-4 font-hairline">
              <p class="text-black mb-2">
                <a href="#">Stylish Green Floral Print Mid Thigh L</a>... Arrives 19 Sep By Prince & Princes
              </p>
              <p class="text-gray-500 mb-2">
                <span>Size:</span>3-4 years
              </p>
              <p class="relative mb-2">
                <span class="text-sm top-0 mt-1 absolute">₹</span>
                <span class="text-black font-bold mb-2 text-2xl ml-2">889</span>
                <span class="text-gray-300 line-through ml-2">₹1049</span>
              ...
              <div class="flex justify-between">
                <div class="w-1/2 left-0">
                  <div class="inline-block relative w-24">
                    <select
                      class="text-sm font-bold text-gray-500 p-2 border-gray-300 cursor-pointer cursor-pointer block appearance-none w-full bg-gray-200 rounded border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 leading-tight focus:outline-none focus:none"
                    >
