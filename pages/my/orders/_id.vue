<template>
  <div>
    ...
    <div
      class="flex flex-wrap justify-between bg-gray-200 shadow"
      v-else
    >
      <div class="w-full py-5 text-sm tracking-widest text-center text-black bg-white">
        ...
        <Span class="flex flex-wrap justify-center text-xs text-gray-600">
          ...
          <li class="ml-2 list-disc">{{order.amount.total | currency}} for 1 item</li>
        </Span>
      </div>
        ...
        >
          ...
          <div class="right-0 lg:w-4/5 xs:9/12">
            <div class="pl-4 font-hairline">
              ...
              <div class="relative">
                <span class="text-2xl font-bold text-black">{{i.price | currency}}</span>
              </div>
      ...
      <div class="w-full px-3 mt-10 mb-8 lg:w-1/4 lg:pr-20">
        <div class="relative flex flex-wrap justify-between w-full pb-2 text-sm font-semibold tracking-widest">SHIPPING ADDRESS</div>
        <div class="p-4 text-sm leading-loose text-gray-700 bg-white rounded shadow">
        ...
        <p class="mt-4 text-sm font-normal font-semibold tracking-widest text-black">PAYMENT SUMMERY</p>
        <div class="right-0 p-4 pb-3 mt-2 text-sm leading-loose bg-white rounded shadow">
        ...
        <div class="flex-no-wrap justify-center p-2 mt-3 text-sm text-center text-gray-700 bg-white border-b border-gray-200 rounded shadow">
          <div>
            <img
              src="/help.png"
              class="m-auto"
