<template>
  <div style="background:#f5f5f5">
    ...
    <div class="w-full lg:w-4/5 m-auto flex lg:border lg:border-gray-300">
      ...
      <div
        class="lg:block flex-1 text-center bg-white"
        :class="{'hidden lg:block':step!==2}"
      >
        <div
          class="bg-white"
          @click="step=2"
      ...
      <div
        ...
        :class="{'hidden lg:block':step!==3}"
      >
        <div
          class="py-4 bg-white text-center hidden lg:block"
          :class="{'text-pink-500 border-b border-pink-500':step==3}"
        >Confirm</div>
        <div :class="{'mask':step!=3}">
