<template>
  <div class="w-full p-5 mt-0 bg-white shadow lg:w-1/2 lg:mt-10 xs:w-full lg:ml-10">
    <div class="border-b border-gray-300">
      <div class="px-0 py-4 text-lg font-bold border-b border-gray-200 headings lg:px-8">
        <i
