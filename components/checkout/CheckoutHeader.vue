<template>
  <div class="flex flex-wrap justify-between p-2">
    <div class="order-0 lg:order-0">
      <nuxt-link to="/">
        <img alt="logo" class="w-12 h-10" src="/logo.svg" />
      </nuxt-link>
    </div>
    <div
    ...
    >
      ...
      <div href class="text-green-500 border-b-2 border-green-500 pb-1">ADDRESS</div>
      <hr class="flex-1 mx-4 my-2" style="border-top:dashed 1px;" />
      <div href>PAYMENT</div>
    </div>
    <div class="order-1 lg:order-3 text-center flex items-center">
      <img alt="secure hield" src="/secure.png" class="w-10" />
