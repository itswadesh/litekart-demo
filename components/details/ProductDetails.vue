<template>
  <div class="w-full md:w-6/12 lg:w-7/12 p-2 px-10 leading-loose">
    ...
    <div class="text-gray-700 font-semibold py-3 tracking-wider">
      <span class="text-2xl mr-2">Rs. 549</span>
      <span class="font-hairline line-through text-lg mr-2">Rs. 1099</span>
      <span class="text-orange-500 text-xl">(50% OFF)</span>
