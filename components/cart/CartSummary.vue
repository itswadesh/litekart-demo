  ...
  <div class="px-3 mt-10 lg:w-1/4 lg:pr-20 xs:w-full">
    ...
    <div class="right-0 border-b border-dotted 4/5 lg:mb-0">
      <div>
        ...
        <span class="text-xs text-gray-400">Includes GST and all government taxes</span>
        <div class="flex justify-between mt-1">
          <div class="w-1/2 text-sm text-left">Total item price</div>
          <div class="w-1/2 ml-2 text-right text-black-400">{{cart.subtotal| currency}}</div>
        </div>
        <div class="flex justify-between mt-1">
          <div class="w-1/2 text-sm text-left">Item discount</div>
          <div class="w-1/2 ml-2 text-right text-black-400">{{cart.discount | currency}}</div>
        </div>
        <div
    ...
    >
      <div class="flex justify-between mt-2">
        ...
        <div class="w-1/2 ml-2 font-bold text-right text-black-400">{{cart.total | currency}}</div>
      </div>
