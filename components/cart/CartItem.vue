<template>
  <div class="flex hr-line justify-between pt-5 pb-5">
    <div class="lg:w-1/5 left-0 xs:w-1/6">
      <div>
        <img class="lg:rounded xs:rounded-b-none w-64" v-lazy="item.product.img" />
        <div
    ...
    <div class="lg:w-4/5 right-0 xs:9/12">
      <div class="pl-4 font-hairline">
        <p class="text-black mb-2">
          ...
          >{{item.product.name | truncate(30)}}</nuxt-link>... Arrives 19 Sep By Prince & Princes
        </p>
        ...
        <div class="flex justify-between">
          <div class="w-1/2 left-0">
            <cart-buttons :product="{_id:item.product._id}" :variant="{_id:item.variant._id}" />
