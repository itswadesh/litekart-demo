    ...
    >
      ...
      <div class="mega-menu mb-16 sm:mb-0 shadow-xl">
        <div class="mx-auto w-full flex flex-wrap justify-between mx-2">
          <ul class="bg-gray-100 px-4 w-full sm:w-1/2 lg:w-1/5 border-gray-600 border-b lg:border-b-0 pb-6 pt-6 lg:pt-3">
          ...
          <ul class="bg-gray-200 px-4 w-full sm:w-1/2 lg:w-1/5 border-gray-600 border-b lg:border-b-0 pb-6 pt-6 lg:pt-3">
            <div class="flex items-center">
              <h3 class="font-bold text-sm text-black text-bold mb-2">
                Mobile Accessories
                <i
